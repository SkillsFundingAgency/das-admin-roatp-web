...
public class ApprenticeshipUnitsUpdateControllerPostTests
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        viewModel.ApprenticeshipUnitsSelectionId = containsApprenticeshipUnits ? 1 : 0;
    ...
    public async Task Post_ProviderTypeChange_ChangePosted(
       ...
       [Frozen] Mock<IOuterApiClient> outerApiClientMock,
       [Frozen] Mock<IValidator<ApprenticeshipUnitUpdateViewModel>> validator,
       [Greedy] ApprenticeshipUnitsUpdateController sut,
       GetOrganisationResponse getOrganisationResponse,
       ApprenticeshipUnitUpdateViewModel viewModel,
       int ukprn,
       CancellationToken cancellationToken)
    {
        ...
        viewModel.ApprenticeshipUnitsSelectionId = isShortCourseTypePresent ? 0 : 1;
    ...
    [Test]
    [MoqInlineAutoData]
    public async Task Post_ProviderTypeChange_ValidationTriggered(
        [Frozen] Mock<IOuterApiClient> outerApiClientMock,
        [Frozen] Mock<IValidator<ApprenticeshipUnitUpdateViewModel>> validator,
        [Greedy] ApprenticeshipUnitsUpdateController sut,
        GetOrganisationResponse getOrganisationResponse,
        ...
        CancellationToken cancellationToken)
    {
        ...
        result.Should().NotBeNull();
        var model = result!.Model as ApprenticeshipUnitUpdateViewModel;
