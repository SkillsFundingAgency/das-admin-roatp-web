...
public class RestrictCourseSearchControllerPostTests
{
    ...
    private const string SelectedLarsCode = RestrictCourseSearchControllerGetTests.UnrestrictedLarsCode;
    ...
    {
        RestrictCourseSearchControllerGetTests.SetupSearchableCourses(outerApiClientMock);
        ...
        sessionServiceMock.Verify(s => s.Set(
            ...
            It.Is<RestrictCourseSessionModel>(m =>
                ...
                m.Title == RestrictCourseSearchControllerGetTests.UnrestrictedCourseTitle &&
                m.Level == RestrictCourseSearchControllerGetTests.UnrestrictedCourseLevel &&
