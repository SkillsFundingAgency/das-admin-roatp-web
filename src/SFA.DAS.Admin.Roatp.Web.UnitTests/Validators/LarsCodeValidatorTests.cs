...
public class LarsCodeValidatorTests
{
    ...
    [Test, MoqAutoData]
    public async Task WhenValidatingLarsCode_AndServiceReturnsNull_ThenHasValidationError(
        [Frozen] Mock<ILarsCodeService> larsCodeServiceMock,
        [Greedy] LarsCodeValidator sut,
        string larsCode)
    {
    ...
    [MoqInlineAutoData("")]
    [MoqInlineAutoData("   ")]
    public async Task WhenValidatingLarsCode_AndLarsCodeIsBlank_ThenHasValidationErrorWithoutCallingService(
        string larsCode,
        [Frozen] Mock<ILarsCodeService> larsCodeServiceMock,
        [Greedy] LarsCodeValidator sut)
    {
