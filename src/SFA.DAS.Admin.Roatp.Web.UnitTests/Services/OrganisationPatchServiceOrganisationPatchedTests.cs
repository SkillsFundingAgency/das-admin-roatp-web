...
public class OrganisationPatchServiceOrganisationPatchedTests
{
    ...
    )
    {
        ...
        outerApiClientMock.Setup(x => x.PatchOrganisation(ukprn, It.IsAny<string>(), It.IsAny<string>(), It.IsAny<JsonPatchDocument<PatchOrganisationModel>>(), cancellationToken))!
